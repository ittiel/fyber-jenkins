...
#RUN sh -c "echo 'deb http://download.opensuse.org/repositories/devel:/kubic:/libcontainers:/stable/xUbuntu_11/ /' > /etc/apt/sources.list.d/devel:kubic:libcontainers:stable.list"
#RUN wget -nv https://download.opensuse.org/repositories/devel:kubic:libcontainers:stable/xUbuntu_11/Release.key -O- | apt-key add -
RUN apt-get update && apt-get -qq --yes install podman
